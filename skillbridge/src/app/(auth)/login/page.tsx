      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">Continue your career journey</p>
          </div>
        </div>
        <div className="card space-y-4">
          ...
          <p className="text-center text-xs text-text-secondary">
            New to SkillBridge?{' '}
            <Link href="/signup" className="text-primary hover:underline">Create free account</Link>
          </p>
        </div>
      </div>
    </div>
