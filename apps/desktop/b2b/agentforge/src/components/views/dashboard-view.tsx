                          ...
                          >
                            ...
                            <td className="px-3 py-2 text-right">
                              <div className="flex items-center justify-end gap-1">
                                <button onClick={(e) => { e.stopPropagation(); handleDuplicateAgent(agent); }} aria-label="Duplicate agent" className="rounded p-1 text-text-tertiary hover:bg-bg-surface-hover hover:text-text-secondary">
                                  <Copy className="h-3 w-3" />
                                </button>
                                <button onClick={(e) => e.stopPropagation()} aria-label="Export agent" className="rounded p-1 text-text-tertiary hover:bg-bg-surface-hover hover:text-text-secondary">
                                  <FileOutput className="h-3 w-3" />
                                </button>
                                <button onClick={(e) => { e.stopPropagation(); handleDeleteAgent(agent.id); }} aria-label="Delete agent" className="rounded p-1 text-text-tertiary hover:bg-error/10 hover:text-error">
