    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface px-4">
        <div className="w-full max-w-sm text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-sage-100 mx-auto mb-3">
          ...
          <Link href="/login" className="text-sage-600 hover:text-sage-700 font-medium text-sm mt-4 inline-block">
            Back to sign in
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-text-secondary mt-1">Start planning with peace of mind</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <Input name="full_name" type="text" label="Full Name" placeholder="Your full name" required />
