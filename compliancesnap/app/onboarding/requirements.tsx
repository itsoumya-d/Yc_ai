...
const OPTIONS = [
  { id: 'osha', label: 'OSHA Safety', icon: 'shield-checkmark' },
  { id: 'food_safety', label: 'Food Safety', icon: 'leaf' },
  { id: 'fire', label: 'Fire Safety', icon: 'flame' },
  { id: 'env', label: 'Environmental', icon: 'earth' },
];
...
export default function RequirementsScreen() {
  ...
  return (
    <View style={s.container}>
      <Text style={s.title}>Compliance Type</Text>
      ...
      <TouchableOpacity style={[s.btn, !selected && s.btnDis]} onPress={() => selected && router.push('/onboarding/demo')} disabled={!selected}>
