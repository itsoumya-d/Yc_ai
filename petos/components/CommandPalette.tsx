...
const useCommandPaletteItems = () => {
  ...
  return React.useMemo<PaletteItem[]>(() => [
    // Navigate
    {
      id: 'nav-dashboard',
      label: 'Dashboard',
      description: 'Overview of all your pets',
    ...
    },
    {
      id: 'nav-pets',
      label: 'My Pets',
      description: 'All your pet profiles',
    ...
    },
    {
      ...
      keywords: ['health', 'records', 'medical'],
    },
    {
      id: 'nav-appointments',
      label: 'Appointments',
      description: 'Vet and grooming appointments',
      icon: <Calendar className="h-4 w-4" />,
      group: 'Navigate',
      action: () => router.push('/appointments'),
      keywords: ['appointments', 'vet', 'schedule'],
    },
    {
      id: 'nav-expenses',
      label: 'Expenses',
      description: 'Track pet care costs',
      icon: <DollarSign className="h-4 w-4" />,
      group: 'Navigate',
      action: () => router.push('/expenses'),
      keywords: ['expenses', 'costs', 'money'],
    },
    {
      id: 'nav-vaccines',
      label: 'Vaccines',
      description: 'Vaccination records and reminders',
      icon: <Syringe className="h-4 w-4" />,
      group: 'Navigate',
      action: () => router.push('/vaccines'),
      keywords: ['vaccines', 'vaccinations', 'shots'],
    },
    {
      id: 'nav-medications',
      label: 'Medications',
      ...
      keywords: ['medications', 'medicine', 'drugs'],
    },
    {
      ...
      group: 'Navigate',
      action: () => router.push('/symptom-check'),
      keywords: ['symptom', 'check', 'ai', 'diagnose'],
    },
    {
      id: 'nav-emergency',
      label: 'Emergency',
      description: 'Emergency resources and contacts',
    ...
    // Actions
    {
      ...
      group: 'Actions',
      action: () => router.push('/pets/new'),
      keywords: ['create', 'add', 'new', 'pet'],
    },
    {
      ...
      keywords: ['create', 'schedule', 'appointment', 'vet'],
    },
    // Settings
    {
      id: 'settings-profile',
            ...
            <div className="rounded-xl border border-border bg-background shadow-2xl overflow-hidden" role="dialog" aria-modal="true" aria-label="Command palette">
              <div className="flex items-center gap-3 border-b border-border px-4 py-3">
                ...
                <input
                  ...
                  placeholder="Search pets, appointments, health records..."
                          ...
                          return (
                            ...
                            >
                              <span
                                ...
                                style={{
                                  backgroundColor: (typeColors[result.type] ?? '#EC4899') + '22',
                                  color: typeColors[result.type] ?? '#EC4899',
                                }}
                              >
                                {result.type}
                              </span>
