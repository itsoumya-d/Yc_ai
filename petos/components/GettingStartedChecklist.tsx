...
const STEPS: ChecklistStep[] = [
  { id: 'add-pet', title: 'Add your first pet', description: 'Create a health profile for your furry friend.', href: '/pets/new', cta: 'Add pet' },
  { id: 'log-weight', title: "Log your pet's weight", description: 'Track weight trends over time.', href: '/pets', cta: 'Log weight' },
  { id: 'add-vaccination', title: 'Record a vaccination', description: 'Keep vaccination records up to date.', href: '/pets', cta: 'Add vaccination' },
  { id: 'book-vet', title: 'Book a telehealth session', description: 'Get expert advice from a licensed vet.', href: '/telehealth', cta: 'Book session' },
  { id: 'explore-community', title: 'Join the pet community', description: 'Connect with other pet owners.', href: '/community', cta: 'Explore community' },
];

const STORAGE_KEY = 'petos_checklist_done';
const DISMISS_KEY = 'petos_checklist_dismissed';
      ...
      >
        <div className="flex-1">
          <div className="flex items-center justify-between mb-1.5">
            <h3 className="text-sm font-semibold text-foreground">Getting started with Petos</h3>
