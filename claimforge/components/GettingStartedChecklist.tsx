...
const STEPS: ChecklistStep[] = [
  { id: 'create-case', title: 'Open your first case', description: 'Start tracking a legal claim or matter.', href: '/cases', cta: 'Open case' },
  { id: 'upload-document', title: 'Upload case documents', description: 'Add evidence, contracts, and legal documents.', href: '/documents', cta: 'Upload documents' },
  { id: 'add-entity', title: 'Add an entity or party', description: 'Track individuals and organizations involved in the case.', href: '/entities', cta: 'Add entity' },
  { id: 'run-analysis', title: 'Run AI case analysis', description: 'Let AI identify key patterns and relationships.', href: '/analysis', cta: 'Run analysis' },
  { id: 'build-timeline', title: 'Build the case timeline', description: 'Map out events chronologically for clarity.', href: '/timeline', cta: 'Build timeline' },
];

const STORAGE_KEY = 'claimforge_checklist_done';
const DISMISS_KEY = 'claimforge_checklist_dismissed';
      ...
      >
        <div className="flex-1">
          <div className="flex items-center justify-between mb-1.5">
            <h3 className="text-sm font-semibold text-foreground">Getting started with ClaimForge</h3>
