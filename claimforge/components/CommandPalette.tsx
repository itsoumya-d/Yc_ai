...
const useCommandPaletteItems = () => {
  ...
  return React.useMemo<PaletteItem[]>(() => [
    ...
    },
    {
      ...
      keywords: ['claims', 'insurance', 'cases'],
    },
    {
      id: 'nav-cases',
      label: 'Cases',
      ...
      keywords: ['cases', 'files', 'investigations'],
    },
    {
      id: 'nav-documents',
      label: 'Documents',
      ...
      keywords: ['documents', 'evidence', 'files', 'upload'],
    },
    {
      id: 'nav-analysis',
      label: 'Analysis',
      ...
      keywords: ['analysis', 'fraud', 'detection'],
    },
    {
      id: 'nav-analytics',
      label: 'Analytics',
      description: 'Claims analytics and trends',
      icon: <BarChart3 className="h-4 w-4" />,
      group: 'Navigate',
      action: () => router.push('/analytics'),
      keywords: ['analytics', 'reports', 'insights', 'trends'],
    },
    {
      id: 'nav-reports',
      label: 'Reports',
      ...
      keywords: ['reports', 'export', 'compliance'],
    },
    {
      id: 'nav-team',
      label: 'Team',
      ...
      keywords: ['team', 'members', 'investigators'],
    },
    // Actions
    {
      id: 'action-new-claim',
      label: 'New Claim',
      description: 'Open a new claim for investigation',
      icon: <Plus className="h-4 w-4 text-primary" />,
      group: 'Actions',
      action: () => router.push('/claims/new'),
      keywords: ['create', 'new', 'claim', 'open'],
    },
    {
      id: 'action-new-case',
      label: 'New Case',
      ...
      keywords: ['create', 'new', 'case', 'investigation'],
    },
    // Settings
    {
      id: 'settings-profile',
      label: 'Profile',
      description: 'Edit your investigator profile',
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="rounded-xl border border-border-default bg-bg-surface shadow-2xl overflow-hidden" role="dialog" aria-modal="true" aria-label="Command palette">
              <div className="flex items-center gap-3 border-b border-border-default px-4 py-3">
                ...
                <input
                  ...
                  placeholder="Search cases, claims, documents..."
                  aria-label="Search commands"
                  className="flex-1 bg-transparent text-sm text-text-primary placeholder:text-text-tertiary outline-none"
                />
                <kbd className="hidden sm:inline-flex h-5 items-center rounded border border-border-default bg-bg-surface-raised px-1.5 font-mono text-[10px] text-text-tertiary">ESC</kbd>
              </div>
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                isActive
                                  ...
                                  : 'text-text-secondary hover:bg-bg-surface-raised/60 hover:text-text-primary'
                              )}
                            >
                              <span
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {result.subtitle && (
                                  <span className="ml-2 text-xs text-text-tertiary truncate">{result.subtitle}</span>
                                )}
                              </div>
              ...
              <div className="border-t border-border-default px-3 py-2 flex items-center gap-4 text-[11px] text-text-tertiary">
                <span className="flex items-center gap-1">
                  <kbd className="rounded border border-border-default bg-bg-surface-raised px-1 py-0.5 font-mono">↑↓</kbd>Navigate
                </span>
                <span className="flex items-center gap-1">
                  <kbd className="rounded border border-border-default bg-bg-surface-raised px-1 py-0.5 font-mono">↵</kbd>Open
                </span>
                <span className="flex items-center gap-1">
                  <kbd className="rounded border border-border-default bg-bg-surface-raised px-1 py-0.5 font-mono">ESC</kbd>Close
                </span>
              </div>
            </div>
          </motion.div>
