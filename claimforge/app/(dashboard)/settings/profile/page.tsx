...
export default function ProfilePage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    setSaving(false);
    setMessage(result?.error ? 'Error: ' + result.error : 'Profile updated successfully!');
  }
  ...
  return (
    <div className="max-w-2xl space-y-8">
      ...
      <form onSubmit={handleSave} className="rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-red-500"
          />
        </div>
      ...
      <section className="rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Download a copy of all your account data (GDPR right to portability).</p>
        <button
      ...
      <section className="rounded-xl border border-red-200 dark:border-red-800 p-6 space-y-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Permanently delete your account and all data. This cannot be undone.</p>
        {!showDeleteConfirm ? (
          <button
          ...
          <div className="space-y-3 p-4 rounded-lg bg-red-50 dark:bg-red-900/10">
            <p className="text-sm font-medium text-red-600 dark:text-red-400">Are you absolutely sure? This will permanently delete all your data.</p>
