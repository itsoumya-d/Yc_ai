...
export default function LoginPage() {
  ...
  return (
    <div className="rounded-xl border border-border-default bg-bg-surface p-8">
      <h1 className="legal-heading text-lg text-text-primary">{t('signIn')}</h1>
      ...
      <button
        ...
        className="mt-3 flex h-10 w-full items-center justify-center gap-3 rounded-lg border border-border-default bg-bg-surface-raised text-sm font-medium text-text-primary transition-colors hover:bg-bg-surface-hover disabled:opacity-50"
      >
        ...
        {githubLoading ? t('redirecting') : t('continueWithGitHub')}
      </button>
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center">
          <span className="bg-bg-surface px-2 text-[10px] text-text-tertiary">{t('orSignInWithEmail')}</span>
        </div>
      </div>
