...
| `NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY` | Stripe publishable key for client-side Checkout | `pk_live_xxxx` |
...
| `SENDGRID_API_KEY` | SendGrid transactional email key | `SG.xxxx` |
