...
const PLANS = [
  {
    ...
    price: '$0',
    period: '/month',
    features: ['5 stories', 'Basic editor', 'Public profile', 'Community reading'],
    cta: 'Current Plan',
    highlighted: false,
    priceId: null,
  },
  {
    ...
    price: '$19',
    period: '/month',
    features: ['Unlimited stories', 'AI writing assistant', 'Analytics & insights', 'Custom domain', 'Early access features', 'Priority support'],
    cta: 'Upgrade to Pro',
    highlighted: true,
  ...
  },
  {
    ...
    price: '$49',
    period: '/month',
    features: ['Everything in Pro', 'Team workspaces', 'Brand kit & white-label', 'Advanced analytics', 'API access', 'Dedicated support'],
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-red-600 dark:text-red-500 mt-1">
              If you cancel, you&apos;ll be downgraded to the Free plan at the end of your billing period.
            </p>
          </div>
          <ManageBillingButton />
        </div>
