...
export const metadata = { title: 'Privacy Policy | StoryThread' };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground">You have the right to access, correct, or delete your personal information. You may also object to or restrict certain processing of your data. To exercise these rights, please contact us at privacy@storythread.com.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">If you have questions about this Privacy Policy, please contact us at <a href="mailto:privacy@storythread.com" className="text-primary hover:underline">privacy@storythread.com</a>.</p>
          </section>
        </div>
