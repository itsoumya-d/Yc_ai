...
const STEPS: ChecklistStep[] = [
  { id: 'create-story', title: 'Create your first story', description: 'Start your creative journey by writing your first story.', href: '/stories/new', cta: 'Write story' },
  { id: 'invite-collaborator', title: 'Invite a collaborator', description: 'Share your story and get feedback from co-authors.', href: '/stories', cta: 'Invite collaborator' },
  { id: 'publish-story', title: 'Publish a chapter', description: 'Share your writing with the StoryThread community.', href: '/stories', cta: 'Publish chapter' },
  { id: 'follow-writer', title: 'Follow a writer', description: 'Discover stories from talented authors.', href: '/discover', cta: 'Discover writers' },
  { id: 'complete-profile', title: 'Complete your profile', description: 'Add a bio and profile picture to attract readers.', href: '/settings/profile', cta: 'Edit profile' },
];

const STORAGE_KEY = 'storythread_checklist_done';
const DISMISS_KEY = 'storythread_checklist_dismissed';
      ...
      >
        <div className="flex-1">
          <div className="flex items-center justify-between mb-1.5">
            <h3 className="text-sm font-semibold text-foreground">Getting started with StoryThread</h3>
