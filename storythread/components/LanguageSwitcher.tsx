  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-purple-800 text-purple-300 hover:text-white transition-colors"
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors text-left ${
                  lang.code === locale
                    ...
                    : 'text-[var(--muted-foreground)] hover:bg-purple-800 hover:text-white'
                }`}
                role="option"
