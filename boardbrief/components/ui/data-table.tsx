...
function exportToCSV<T>(
  ...
  // Only export columns that have no custom render and are visible
  ...
  return (
    <div className={cn('space-y-3', className)}>
      ...
      {selectable && selected.size > 0 && (
        <div className="flex items-center gap-3 rounded-lg border border-border bg-muted/60 px-3 py-2 animate-in slide-in-from-top-1 duration-200">
