...
const PLANS = [
  {
    ...
    price: '$0',
    period: '/month',
    features: ['5 meetings', 'Basic minutes', 'Action items tracking', 'PDF export'],
    cta: 'Current Plan',
    highlighted: false,
    priceId: null,
  },
  {
    ...
    price: '$99',
    period: '/month',
    features: ['Unlimited meetings', 'AI agenda builder', 'E-signatures', 'Investor updates', 'QuickBooks & Stripe sync', 'Board portal access'],
    cta: 'Upgrade to Pro',
    highlighted: true,
  ...
  },
  {
    ...
    price: '$299',
    period: '/month',
    features: ['Everything in Pro', 'Multi-company management', 'Custom branding', 'Advanced KPI dashboards', 'Audit-ready reports', 'Dedicated support'],
      ...
      <div>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
          <div className="bg-gray-50 dark:bg-gray-800 px-4 py-3 grid grid-cols-4 gap-4 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
            <span>{t('date')}</span>
            <span>{t('invoiceDescription')}</span>
            <span>{t('amount')}</span>
            <span>{t('status')}</span>
          </div>
