...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{t('profileSettings')}</h1>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{t('profileDescription')}</p>
      </div>
      ...
      <form onSubmit={handleSave} className="rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
      ...
      <section className="rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">{t('yourDataDescription')}</p>
        <button
      ...
      <section className="rounded-xl border border-red-200 dark:border-red-800 p-6 space-y-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">{t('dangerZoneDescription')}</p>
        {!showDeleteConfirm ? (
          <button
          ...
          <div className="space-y-3 p-4 rounded-lg bg-red-50 dark:bg-red-900/10">
            ...
            <div className="flex gap-3">
              ...
              >
                {deleting ? t('deleting') : t('yesDeleteAccount')}
              </button>
              <button
