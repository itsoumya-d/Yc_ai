    ...
    <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-8 shadow-[var(--shadow-card)]">
      ...
      <div className="mt-4">
        <button
          ...
          disabled={loading}
          className="w-full rounded-lg border border-[var(--border)] bg-[var(--background)] px-4 py-2.5 text-sm font-medium text-[var(--foreground)] transition-colors hover:bg-[var(--accent)] focus:ring-2 focus:ring-brand-500/20 focus:outline-none disabled:opacity-50"
        >
          {t('sendMagicLink')}
        </button>
      </div>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--background)] px-4 py-2.5 text-sm font-medium text-[var(--foreground)] transition-colors hover:bg-[var(--accent)] focus:ring-2 focus:ring-brand-500/20 focus:outline-none mb-2"
      >
