...
const STEPS: ChecklistStep[] = [
  { id: 'add-client', title: 'Add your first client', description: 'Create a client profile to start sending invoices.', href: '/clients/new', cta: 'Add client' },
  { id: 'create-invoice', title: 'Create your first invoice', description: 'Generate a professional invoice in seconds.', href: '/invoices/new', cta: 'Create invoice' },
  { id: 'connect-bank', title: 'Set up payment methods', description: 'Accept payments faster with Stripe integration.', href: '/settings', cta: 'Setup payments' },
  { id: 'add-expense', title: 'Log an expense', description: 'Track business expenses for tax time.', href: '/expenses', cta: 'Add expense' },
  { id: 'setup-recurring', title: 'Create a recurring invoice', description: 'Automate billing for retainer clients.', href: '/recurring', cta: 'Set up recurring' },
];

const STORAGE_KEY = 'invoiceai_checklist_done';
const DISMISS_KEY = 'invoiceai_checklist_dismissed';
      ...
      >
        <div className="flex-1">
          <div className="flex items-center justify-between mb-1.5">
            <h3 className="text-sm font-semibold text-foreground">Getting started with InvoiceAI</h3>
