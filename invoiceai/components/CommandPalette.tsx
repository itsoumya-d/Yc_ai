...
const useCommandPaletteItems = () => {
  ...
  return React.useMemo<PaletteItem[]>(() => [
    // Navigate
    {
      id: 'nav-dashboard',
      label: 'Dashboard',
      description: 'Revenue overview and analytics',
    ...
    },
    {
      id: 'nav-clients',
      label: 'Clients',
      description: 'Your client list and contacts',
    ...
    },
    {
      ...
      group: 'Navigate',
      action: () => router.push('/recurring-invoices'),
      keywords: ['recurring', 'subscription', 'automatic'],
    },
    {
      id: 'nav-followups',
      label: 'Follow-ups',
      description: 'Payment reminders and follow-ups',
      icon: <Bell className="h-4 w-4" />,
      group: 'Navigate',
      action: () => router.push('/follow-ups'),
      keywords: ['reminders', 'followup', 'overdue'],
    },
    {
      id: 'nav-reports',
      label: 'Reports',
                          ...
                          return (
                            ...
                            >
                              <span
                                ...
                                style={{
                                  backgroundColor: (typeColors[result.type] ?? '#6366F1') + '22',
                                  color: typeColors[result.type] ?? '#6366F1',
                                }}
                              >
                                {result.type}
                              </span>
