  ...
  if (sent) {
    return (
      <Card>
        ...
        <CardContent><Link href="/login"><Button variant="outline" className="w-full">Back to Sign In</Button></Link></CardContent>
      </Card>
    );
  }
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <p className="mt-4 text-center text-sm text-[var(--muted-foreground)]"><Link href="/login" className="text-brand-600 hover:underline">Back to Sign In</Link></p>
      </CardContent>
    </Card>
  );
}
