...
const useCommandPaletteItems = () => {
  ...
  return React.useMemo<PaletteItem[]>(() => [
    // Navigate
    {
      id: 'nav-dashboard',
      label: 'Dashboard',
      description: 'Pipeline overview and stats',
    ...
    },
    {
      id: 'nav-proposals',
      label: 'Proposals',
      description: 'All your proposals',
      icon: <FileText className="h-4 w-4" />,
      group: 'Navigate',
      action: () => router.push('/proposals'),
      keywords: ['proposals', 'quotes', 'documents'],
    },
    {
      id: 'nav-clients',
      label: 'Clients',
      description: 'Client contacts and accounts',
    ...
    },
    {
      ...
      keywords: ['content', 'library', 'blocks'],
    },
    {
      id: 'nav-analytics',
      label: 'Analytics',
      description: 'Proposal performance insights',
    ...
    // Actions
    {
      ...
      icon: <Send className="h-4 w-4 text-brand-600" />,
      group: 'Actions',
      action: () => router.push('/proposals/new'),
      keywords: ['create', 'new', 'proposal'],
    },
    {
      ...
      keywords: ['create', 'add', 'client', 'new'],
    },
    // Settings
    {
      id: 'settings-profile',
                          ...
                          return (
                            ...
                            >
                              <span
                                ...
                                style={{
                                  backgroundColor: (typeColors[result.type] ?? '#2563EB') + '22',
                                  color: typeColors[result.type] ?? '#2563EB',
                                }}
                              >
                                {result.type}
                              </span>
