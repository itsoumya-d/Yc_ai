...
import { LayoutDashboard, FileText, Users, LayoutTemplate, Library, Settings, Plus, Send, Menu, PanelLeftClose, LogOut, BarChart2, Calculator } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Pricing Calc', href: '/pricing-calculator', icon: Calculator },
];
