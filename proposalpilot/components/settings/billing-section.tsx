...
import { CreditCard, Loader2, Zap, Building2, Sparkles } from 'lucide-react';
...
const PLANS = [
  {
    ...
    price: '$19',
    period: '/mo',
    proposals: '20 proposals/mo',
    icon: Zap,
    color: 'text-blue-600',
    features: ['AI proposal generation', 'E-signature', 'PDF export', 'Share links'],
  },
  {
    id: 'pro',
    name: 'Pro',
    price: '$49',
    period: '/mo',
    proposals: '100 proposals/mo',
    icon: Sparkles,
    color: 'text-purple-600',
    features: ['Everything in Starter', 'Analytics dashboard', 'Custom templates', 'Priority support'],
  },
  {
    id: 'agency',
    name: 'Agency',
    ...
    features: ['Everything in Pro', 'Team seats (5)', 'White-label PDF', 'API access'],
  },
];
    ...
    <Card className="p-6">
      ...
      {!isActive && (
        <p className="text-sm text-[var(--muted-foreground)] mb-5">
          You&apos;re on the <strong>Free plan</strong> — limited to 3 proposals/month. Upgrade to unlock AI generation, e-signatures, and more.
        </p>
      )}
          ...
          return (
            <div key={p.id} className={`rounded-lg border p-4 ${isCurrent ? 'border-blue-500 bg-blue-50/40' : 'border-[var(--border)]'}`}>
              ...
              <div className="mb-3">
                ...
                <p className="text-xs text-[var(--muted-foreground)] mt-0.5">{p.proposals}</p>
              </div>
